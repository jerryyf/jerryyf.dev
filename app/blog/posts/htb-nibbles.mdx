...
summary: "Hack The Box Nibbles writeup."
---
...
<Image src={'/blog/htb-nibbles1.png'} alt={'screenshot of dev tools'} />

A standard blog page is shown, looks like it's powered by nibbleblog. We can also note that the title is "Nibbles Yum yum".

<Image src={'/blog/htb-nibbles2.png'} alt={'screenshot of blog page'} />
...
Navigating to `/admin`:
<Image src={'/blog/htb-nibbles3.png'} alt={'screenshot of directory'} />

Navigating to `/admin.php`:
<Image src={'/blog/htb-nibbles4.png'} alt={'screenshot of admin login page'} />
...
<Image src={'/blog/htb-nibbles5.png'} alt={'screenshot of admin dashboard'} />
